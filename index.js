...
mongoose.connect('mongodb+srv://mad_hav:mad_hav@madhav11.t8k8rva.mongodb.net/', { useNewUrlParser: true, useUnifiedTopology: true })
...
app.post('/api/register', (req, res) => {
  console.log("inpost");
  const { uname, name, place, age, email, education, phoneNumber, password ,  dob} = req.body;
